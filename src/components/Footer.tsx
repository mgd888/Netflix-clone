...
const Footer = () => {
    return (
        <div tw="p-10 md:px-[26%] text-left text-[12px]  text-white/25 h-3/5 w-screen backdrop-brightness-0 z-30 text-white border-[#222] border-t-8">
            <p>Questions? Call 1-844-542-4813</p>
            <div tw="flex flex-col justify-items-start">
                <table tw="table-auto w-[100%] text-[8px] sm:text-[12px]">
                    <tbody>
                        <tr>
                            <td>FAQ</td>
                            <td>Help Center</td>
